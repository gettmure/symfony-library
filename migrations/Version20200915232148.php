 ...
 */
final class Version20200915232148 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE books ALTER author_id TYPE UUID');
        $this->addSql('ALTER TABLE books ALTER author_id DROP DEFAULT');
        $this->addSql('COMMENT ON COLUMN books.author_id IS NULL');
        $this->addSql('ALTER TABLE users ALTER book_id TYPE UUID');
        $this->addSql('ALTER TABLE users ALTER book_id DROP DEFAULT');
        $this->addSql('COMMENT ON COLUMN users.book_id IS NULL');
    }
}
